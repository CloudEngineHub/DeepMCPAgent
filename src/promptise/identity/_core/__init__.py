...
the cache primitive, the abstract base class, and the two concrete
bases (file-backed and callable-backed). Code outside
``promptise.identity`` should import from the top-level
